    ...
    app.post('/api/submissions', handleRequest(async (req) => {
        ...
        await db.query(
            'INSERT INTO submissions ("submissionId", "activityId", "lineUserId", description, status, points, "createdAt") VALUES ($1, $2, $3, $4, $5, $6, $7)',
            [submissionId, activityId, lineUserId, description, 'pending', 0, new Date()]
        );
